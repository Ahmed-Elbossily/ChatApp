...
public class ChatListAdapter extends BaseAdapter{
    ...
    private ArrayList<DataSnapshot> snapshotsList;

    private ChildEventListener listener = new ChildEventListener() {
        @Override
        public void onChildAdded(DataSnapshot dataSnapshot, String s) {
            snapshotsList.add(dataSnapshot);
    ...
    public ChatListAdapter(Activity activity, DatabaseReference reference, String name) {
        ...
        this.databaseReference = reference.child("messages");
    ...
    public InstantMessage getItem(int position) {
        DataSnapshot snapshot = snapshotsList.get(position);
